...
Nathan: We need to be able to study and analyze data because this allows us to understand patterns or probabilities of specific outcomes, allowing us to prepare for the possible outcomes, and/or do something to change the probabilities and patterns such that we can make use of it.<br>
...
Nathan: Waze makes use of data that has been gathered in the past, and data gathered by other users, to determine traffic in specific areas, and can give a rough estimate given all the attained data on the route.<br>
